...
<div id="pagewrap">
	...
	<header id="header">
		...
		<nav>
			<ul id="main-nav" class="clearfix">
				<li><a onclick="MostarIngreso()" class="btn">Ingreso/Salida</a></li>
				<li><a onclick="Mostrar('MostrarPerfil')" class="btn">Perfil</a> </li>
				<li><a onclick="Mostrar('MostarFoto')" class="btn">Foto</a> </li>
				<li><a onclick="Mostrar('MostarListado')" class="btn">Listado </a> </li>
	...
	<div id="content" >
		...
		<article  class="post clearfix">
			...
			<header  >
				<h1 class="post-title"><a href="#">Alejandro.Maglione</a></h1>
...
?>
	...
	<aside id="sidebar">
		...
		<section class="widget clearfix" >
			<h4 class="widgettitle">Fecha actual</h4>
				<div id="fecha">
					<?php
					if(isset($_COOKIE['hoy']))
					{
						echo "<h4>".$_COOKIE['hoy']."</h4>";
					}
					else
						echo "";
					?>
